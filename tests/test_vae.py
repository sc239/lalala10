...
def test_vae():
    ...
    TDB = [[[[0.4945720136165619, 0.4981219172477722, 0.5727901458740234, 0.47393736243247986, 0.5422342419624329],
             [0.3777865469455719, 0.6035972833633423, 0.35935717821121216,
                 0.5248180031776428, 0.6372954845428467],
             [0.7058789730072021, 0.6358954310417175, 0.6242976784706116,
                 0.40985599160194397, 0.6531753540039062],
             [0.34155869483947754, 0.4859594702720642, 0.5383022427558899,
                 0.3163289725780487, 0.33808380365371704],
           ...
           [[[0.48010358214378357, 0.5389179587364197, 0.528987467288971, 0.3696441054344177, 0.5190967321395874],
             [0.5110399127006531, 0.5203749537467957, 0.4850541651248932,
                 0.5248721241950989, 0.5043338537216187],
             [0.6214423775672913, 0.5624865889549255, 0.5311568975448608,
                 0.4427820146083832, 0.5605618357658386],
             [0.4446558952331543, 0.464923232793808, 0.6029647588729858,
                 0.4420813322067261, 0.42101797461509705],
    ...
    np.testing.assert_allclose(
        decoded_batch, true_decoded_batch, rtol=1e-06, err_msg=err_msg)
